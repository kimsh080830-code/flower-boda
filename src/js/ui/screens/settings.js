...
function renderSettings(state) {
 ...
 if(state.recentClearPending) recent.append(el('div',{className:'recent-clear-confirm',role:'group',ariaLabel:'최근 본 꽃 삭제 확인'},[
 ...
 else recent.append(button('최근 모두 지우기','clear-recent',{kind:'tertiary',extraClass:'recent-clear-button',disabled:!rows.length}));
 main.append(recent);
 ...
 const saved=el('details',{className:'settings-disclosure'},[el('summary',{text:'저장한 꽃'}),renderFavoriteGarden(state)]);
 main.append(saved);
